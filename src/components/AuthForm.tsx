...
// linha removida ó funÁ„o inexistente
  ...
  const handlePerformReset = () => {
    if (!newPassword || !confirmPassword) {
      alert("Por favor preencha a nova palavra-passe e a confirma√ß√£o.");
      return;
    }
    if (newPassword !== confirmPassword) {
      alert("As palavras-passe introduzidas n√£o coincidem!");
      return;
    }

    if (!resetPolicyVal.isValid) {
      alert("A palavra-passe n√£o cumpre todos os requisitos de seguran√ßa:\n\n‚Ä¢ " + resetPolicyVal.errors.join("\n‚Ä¢ "));
      return;
    }
      ...
      <div className="flex flex-col items-center justify-center pt-1">
        ...
        <div className="mt-2">
          <h2 className="text-sm font-extrabold tracking-wider text-white uppercase font-sans">
            {resetMode ? "Recupera√ß√£o & Desbloqueio" : "PORTAL DE AUTENTICA√á√ÉO"}
          </h2>
        </div>
      </div>
      ...
      {errorMessage && (
        <div className="bg-red-950/80 border border-red-500/60 p-2.5 rounded-xl text-red-200 text-[11px] font-medium text-left flex items-start justify-between gap-2">
          <div className="flex items-start space-x-1.5">
            <span className="text-red-400 font-bold shrink-0">‚ÑπÔ∏è</span>
          ...
          {resetSent ? (
            <div className="bg-emerald-950/70 border border-emerald-500/50 p-3 rounded-xl space-y-2 text-center">
              ...
              <p className="text-[10px] text-slate-300 leading-normal">
                Envi√°mos o link de redefini√ß√£o para: <strong className="text-white font-mono">{email}</strong>.
              </p>
              ...
              <div className="pt-2 border-t border-emerald-500/30 space-y-2 text-left">
                <span className="text-[10px] font-bold text-emerald-400 block uppercase tracking-wider">
                  Redefinir Palavra-passe com Seguran√ßa
                </span>
                ...
                <input
                  ...
                  placeholder="Nova Palavra-passe (m√≠n 12 caract)..."
                ...
                {newPassword && (
                  <div className="bg-slate-950 border border-slate-800 p-2 rounded-lg text-[9px] space-y-1">
                    <div className="flex justify-between font-bold">
                      <span>For√ßa: <strong className="text-emerald-400">{resetPolicyVal.label}</strong></span>
            ...
            <div className="space-y-2.5">
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  />
                  <span className="absolute left-2.5 top-2.5 text-slate-500 text-xs">‚úâ</span>
                </div>
              </div>
        ...
        <form onSubmit={handleStandardLogin} className="space-y-3 text-left pt-0.5">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              />
              <span className="absolute left-2.5 top-2.5 text-slate-500 text-xs">üîí</span>
            </div>
          </div>
          ...
          {biometricScan && (
            <div className="bg-emerald-950/40 border border-emerald-500/40 rounded-xl p-2.5 text-center space-y-1.5 animate-pulse">
              <div className="flex items-center justify-center space-x-1.5 text-emerald-400 text-xs font-bold">
                <span>üñ≤ Verifica√ß√£o Biom√©trica (Face ID)... {biometricProgress}%</span>
              </div>
          ...
          <div className="pt-1 space-y-2">
            ...
            >
              <span>‚ûî] ENTRAR COM PASSWORD</span>
            </button>
            ...
            >
              <span>üñ≤</span>
              <span>Entrar com Dados Biom√©tricos</span>
            </button>
