...
export const initialDocumentos: Documento[] = [
  ...
  // PASTA TEMPORÁRIA DE TESTES E VERIFICAÇÃO DE DOCUMENTOS (MARCA DE ÁGUA & LOGÓTIPO)
  {
    id_doc: "doc-teste-1",
    id_predio: "predio-1",
  ...
  },
  {
    ...
    sub_pasta: "📁 Pasta Temporária - Teste & Verificação (Marca de Água)",
    descricao: "Ata da Assembleia Geral de Condóminos elaborada conforme a Lei n.º 8/2022, contendo deliberações sobre aprovação de contas, fundo de reserva e eleição de administração.",
    visibilidade: "Público",
    autor: "Carlos Administrador (Modo de Testes)",
